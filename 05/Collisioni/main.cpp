...
{
	cout << obj1.corner_b.x << ", " << obj1.corner_b.y << endl;
	cout << obj1.corner_t.x << ", " << obj1.corner_t.y << endl;
	return (obj1.corner_b.x <= obj2.corner_t.x && obj1.corner_t.x >= obj2.corner_b.x) &&
		   (obj1.corner_b.y <= obj2.corner_t.y && obj1.corner_t.y >= obj2.corner_b.y);
}
...
void drawScene(void)
{
	...
	if (Coll == true)
		Scena[1].alive = false; // Se collisione � TRUE, metto a FALSE il flag alive di Farfalla, che ha l'effetto di non farla disegnare pi�
...
int main(int argc, char *argv[])
{
	...
	glutTimerFunc(250, update_Sommergibile, 0); // gestione evento oziosit� : viene richiamata la funzione updateScale ogni 250 millisecondi che aggiorna i parametri di scalatura e forza il ridisegno
