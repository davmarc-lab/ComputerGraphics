...
void InterpolazioneHermite(float* t, Forma* Fig, vec4 color_top, vec4 color_bot)
{
	...
	Fig->vertici.clear();
	Fig->colors.clear();
	Fig->vertici.push_back(vec3(-0.1,0.0, 0.0));
...
int main(int argc, char* argv[])
{
	...
	//glutTimerFunc(250, updateScale, 0);  //gestione evento oziosità: viene richiamata la funzione updateScale ogni 250 millisecondi che aggiorna i parametri di scalatura e forza il ridisegno
